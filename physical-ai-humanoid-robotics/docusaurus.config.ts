...
const config: Config = {
  ...
  organizationName: 'maan314', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/maan314/physical-ai-humanoid-robotics/tree/main/',
        },
        blog: false, // Disable blog as per requirements
        theme: {
